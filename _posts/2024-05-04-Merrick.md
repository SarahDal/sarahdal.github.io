...
{% leaflet_map { "center" : [55.1220, -4.4461],
                 "zoom" : 11,
                 "providerBasemap": "OpenTopoMap"} %}
    {% leaflet_marker {"latitude" : 55.0938,
                       "longitude" : -4.4841,
                       "popupContent": "car park"} %} 
    {% leaflet_geojson "/www/assets/geojson/Merrick1.geojson" %}
    {% leaflet_geojson "/www/assets/geojson/Merrick2.geojson" %}

{% endleaflet_map %}

[geojson](/www/assets/geojson/Merrick2.geojson)
